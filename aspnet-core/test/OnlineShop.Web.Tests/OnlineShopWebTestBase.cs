...
{
    public abstract class OnlineShopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OnlineShopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OnlineShopWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OnlineShopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OnlineShopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OnlineShopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OnlineShopDbContext, Task<T>> func)
        {
            T result;
