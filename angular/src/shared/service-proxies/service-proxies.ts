...
export class CategoryServiceProxy {
    ...
    getAllWithoutPagination(): Observable<CategoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Category/getAllWithoutPagination";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllWithoutPagination(response: HttpResponseBase): Observable<CategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keywords: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CategoryDtoPagedResultDto> {
...
export class ProductServiceProxy {
     ...
     * @return Success
     */
    generateProductCode(): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Product/GenerateProductCode";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGenerateProductCode(<any>response_);
                } catch (e) {
     ...
     * @return Success
     */
    getAll(keywords: string | null | undefined, categoryId: number | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ProductDtoPagedResultDto> {
...
@Injectable()
export class SupplierProductServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @param estimatedDelivery (optional) 
     ...
     * @return Success
     */
    getAll(keywords: string | null | undefined, quantity: number | null | undefined, estimatedDelivery: moment.Moment | null | undefined, userId: number | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<SupplierProductDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/GetAll?";
        if (keywords !== undefined && keywords !== null)
            url_ += "keywords=" + encodeURIComponent("" + keywords) + "&";
        if (quantity !== undefined && quantity !== null)
            url_ += "Quantity=" + encodeURIComponent("" + quantity) + "&";
        if (estimatedDelivery !== undefined && estimatedDelivery !== null)
            url_ += "EstimatedDelivery=" + encodeURIComponent(estimatedDelivery ? "" + estimatedDelivery.toJSON() : "") + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SupplierProductDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<SupplierProductDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<SupplierProductDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SupplierProductDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SupplierProductDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<SupplierProductDto> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SupplierProductDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<SupplierProductDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<SupplierProductDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SupplierProductDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SupplierProductDto>(<any>null);
    }

    /**
     * @return Success
     */
    getAllWithoutPagination(): Observable<SupplierProductDto[]> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/getAllWithoutPagination";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllWithoutPagination(response: HttpResponseBase): Observable<SupplierProductDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(SupplierProductDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    /**
     * @param supplierProductId (optional) 
     * @param quantity (optional) 
     * @return Success
     */
    supply(supplierProductId: number | undefined, quantity: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/Supply?";
        if (supplierProductId === null)
            throw new Error("The parameter 'supplierProductId' cannot be null.");
        else if (supplierProductId !== undefined)
            url_ += "supplierProductId=" + encodeURIComponent("" + supplierProductId) + "&";
        if (quantity === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSupply(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSupply(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSupply(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    create(body: SupplierProductDto | undefined): Observable<SupplierProductDto> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<SupplierProductDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: SupplierProductDto | undefined): Observable<SupplierProductDto> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<SupplierProductDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SupplierProduct/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class SupplierProductDto implements ISupplierProductDto {
    ...
    constructor(data?: ISupplierProductDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.price = _data["price"];
            this.estimatedDelivery = _data["estimatedDelivery"];
    ...
    static fromJS(data: any): SupplierProductDto {
        data = typeof data === 'object' ? data : {};
        let result = new SupplierProductDto();
        result.init(data);
        return result;
    }
...
export class SupplierProductDtoPagedResultDto implements ISupplierProductDtoPagedResultDto {
    totalCount: number;
    items: SupplierProductDto[] | undefined;

    constructor(data?: ISupplierProductDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(SupplierProductDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): SupplierProductDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new SupplierProductDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): SupplierProductDtoPagedResultDto {
        const json = this.toJSON();
        let result = new SupplierProductDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ISupplierProductDtoPagedResultDto {
    totalCount: number;
    items: SupplierProductDto[] | undefined;
}
